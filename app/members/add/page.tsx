...
/**
 * Add Member Form - Uber-style clean form
 */
        ...
        <div className="min-h-screen bg-white">
            ...
            <header className="bg-white border-b border-gray-200">
                <div className="max-w-3xl mx-auto px-6 py-6">
                    ...
                    <h1 className="text-2xl font-semibold text-black">Add New Member</h1>
                </div>
            </header>
                    ...
                    <div className="border-b border-gray-200 pb-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                {plans.length === 0 && (
                                    <p className="mt-2 text-sm text-gray-500">No active plans available</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="startDate"
                                    required
                                    value={formData.membershipStartDate.toISOString().split('T')[0]}
                                    ...
                                    <p className="text-sm text-gray-600">
                                        ...
                                        <span className="font-medium text-black">
                                            {(() => {
                                                const plan = plans.find(p => p.id === formData.planId);
                                                if (!plan) return 'N/A';
                                                const expiry = new Date(formData.membershipStartDate);
